...
public class SearchPageController extends HttpServlet {
 private final static String SUCCESS = "ToSearchPageController";
    private final static String SUCCESS_GE = "ToMainPageController";
    private final static String ERROR = "ToMainPageController";
    private final static Logger LOG = Logger.getLogger(SearchPageController.class);
    /**
